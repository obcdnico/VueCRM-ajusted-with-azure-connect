...
.cssload-circle:nth-child(1) {
  ...
  z-index: -1;
  border: 1px solid rgba(44,32,224,0.7);
}
...
.cssload-circle:nth-child(10) {
  ...
  z-index: -10;
  border: 1px solid rgba(15,14,15,0.7);
}
...
.cssload-circle:nth-child(14) {
  ...
  z-index: -14;
  border: 1px solid rgba(237,159,23,0.7);
}
...
.cssload-circle:nth-child(16) {
  ...
  z-index: -16;
  border: 1px solid rgba(232,21,21,0.98);
}
